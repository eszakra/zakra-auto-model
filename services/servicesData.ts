...
export const WORKFLOWS: ServiceItem[] = [
  {
    ...
    slug: "inpainting-pro",
    name: "Inpainting Pro",
    description: "SDXL Inpainting workflow manually developed by us. Exclusive for ComfyUI and completely ready to use. Designed to give you an advanced generator without knowing absolutely anything about ComfyUI.",
    price: "$197",
    priceValue: 197,
    originalPrice: "$397",
    originalPriceValue: 397,
    discountPercent: "50% OFF",
    features: ["Exclusive for ComfyUI", "Zero knowledge required", "Ready to use (Plug & Play)", "Basic setup guide"],
    popular: false,
    category: "workflow"
  },
  {
    ...
    description: "Workflow manually created by our team to replicate exact poses. Fully ready to install in ComfyUI, built specifically for creators with zero node experience.",
    price: "$297",
    priceValue: 297,
    originalPrice: "$697",
    originalPriceValue: 697,
    discountPercent: "57% OFF",
    features: ["Exclusive for ComfyUI", "Zero knowledge required", "Ready to use instantly", "Exact pose control"],
    popular: true,
    category: "workflow"
  },
  {
    ...
    slug: "elite-bundle",
    name: "Elite Bundle",
    description: "Both ComfyUI workflows + our prompt library. The complete toolkit ready to use, hand-developed so you can produce content without needing to learn ComfyUI.",
    price: "$497",
    priceValue: 497,
    originalPrice: "$997",
    originalPriceValue: 997,
    discountPercent: "50% OFF",
    features: ["Both workflows included", "Prompt library", "Ready to use (Plug & Play)", "1-on-1 VIP support"],
    popular: false,
    category: "workflow"
  }
];
