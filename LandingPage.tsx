          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 mb-10 animate-slide-up" style={{ animationDelay: '0.15s' }}>
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-4 bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white font-semibold rounded-xl hover:bg-white/20 hover:border-white/40 transition-all text-base"
              >
