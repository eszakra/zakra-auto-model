      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-14 lg:pt-24 lg:pb-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-col sm:flex-row items-center lg:items-start justify-center lg:justify-start gap-3 mb-6 animate-slide-up" style={{ animationDelay: '0.15s' }}>
              <button
                onClick={onLaunchApp}
            ...
            {/* Discord CTA - Prominent community button */}
            <div className="flex justify-center lg:justify-start mb-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <a
                href="https://discord.gg/pqSwuGxrmh"
                target="_blank"
                rel="noopener noreferrer"
                className="group inline-flex items-center gap-3 px-6 py-3 bg-[#5865F2] hover:bg-[#4752C4] text-white font-semibold rounded-xl transition-all shadow-lg shadow-[#5865F2]/25 hover:shadow-xl hover:shadow-[#5865F2]/30 hover:-translate-y-0.5"
              >
                ...
                <span className="px-2 py-0.5 bg-white/20 rounded-full text-xs font-bold group-hover:bg-white/30 transition-colors">Community</span>
              </a>
            </div>
