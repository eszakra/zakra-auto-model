      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-14 lg:pt-24 lg:pb-16">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* Discord CTA - Elegant community link */}
            <div className="flex justify-center lg:justify-start mb-10 animate-slide-up" style={{ animationDelay: '0.2s' }}>
              <a
                ...
                className="group inline-flex items-center gap-2.5 text-[var(--text-secondary)] hover:text-[#5865F2] transition-all"
              >
                <div className="flex items-center justify-center w-9 h-9 rounded-full bg-[var(--bg-secondary)] border border-[var(--border-color)] group-hover:border-[#5865F2]/50 group-hover:bg-[#5865F2]/10 transition-all">
